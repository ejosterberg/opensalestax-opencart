...
## Quality bar (as of v0.1.1)

| Gate | Value |
|---|---|
| PHPUnit tests | 91 cases / 193 assertions, all green |
| PHPStan | level `max`, no errors |
| PHP-CS-Fixer | PSR-12 + risky, clean |
| `composer audit` | 0 vulnerabilities |
| SonarQube | 0 BLOCKER / 0 CRITICAL / 0 BUGS / 0 VULNERABILITIES / 0 CODE SMELLS / 0 SECURITY HOTSPOTS (re-scan after Phase 02 ship — pending) |
| Security review threats documented | ≥ 10 in `docs/SECURITY-REVIEW.md` |
...
|---|---|---|
| 03 — v0.2 surface + security | Per-jurisdiction tax-line surface; DNS-rebinding IP-pinning | spec.md + README v0.2 |
| 04 — OC 3.x backport | Different extension model (OCMOD/vqmod) | README v0.2 |
